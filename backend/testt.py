...
POSITIVE_PROJECTS = [
    ...
    {"projectName": "FormSG", "projectUrl": "https://github.com/opengovsg/FormSG",
     ...
     "ground_truth_sdg": 16},
    {"projectName": "BioPAL", "projectUrl": "https://github.com/BioPAL/BioPAL",
     "projectDescription": "The BIOMASS Product Algorithm Laboratory hosts official tools for processing and analysing ESA's BIOMASS mission data."},
    {"projectName": "REEF3D", "projectUrl": "https://github.com/reef3d/reef3d",
     "projectDescription": "An efficiently parallelized hydrodynamics framework with a focus on coastal, marine and hydraulic engineering flows."},
    {"projectName": "HPC4WC", "projectUrl": "https://github.com/ofuhrer/HPC4WC",
     "projectDescription": "High Performance Computing for Weather and Climate Course."},
    {"projectName": "wqtrends", "projectUrl": "https://github.com/tbep-tech/wqtrends",
     "projectDescription": "R package to assess water quality trends with generalized additive models."},
    {"projectName": "CNN-SoilTextureClassification", "projectUrl": "https://github.com/felixriese/CNN-SoilTextureClassification",
     "projectDescription": "One-dimensional convolutional neural networks (CNN) for the classification of soil texture based on hyperspectral data."},
    {"projectName": "met.3D", "projectUrl": "https://gitlab.com/wxmetvis/met.3d",
     "projectDescription": "Interactive three-dimensional visualization of numerical ensemble weather predictions and similar numerical atmospheric model datasets."},
    {"projectName": "PowerModelsAnnex.jl", "projectUrl": "https://github.com/lanl-ansi/PowerModelsAnnex.jl",
     "projectDescription": "An extension of PowerModels.jl that provides a home for open source sharing of preliminary and/or exploratory methods in power system optimization."},
    {"projectName": "3Dstreet", "projectUrl": "https://github.com/3DStreet/3dstreet",
     "projectDescription": "Creates 3D visualizations of your 2D Streetmix.net streets."},
    {"projectName": "ha-evcc", "projectUrl": "https://github.com/marq24/ha-evcc",
     "projectDescription": "Home Assistant integration for evcc optimized charging of electric vehicles, connecting your EV charger with your PV system."},
    {"projectName": "Intake-esm", "projectUrl": "https://github.com/intake/intake-esm",
     "projectDescription": "An intake plugin for parsing an Earth System Model catalog and loading assets into xarray datasets."},
    {"projectName": "getCRUCLdata", "projectUrl": "https://github.com/ropensci/getCRUCLdata",
     "projectDescription": "Provides functions that automate importing CRU CL v. 2.0 climatology data into R."},
    {"projectName": "Land Matrix", "projectUrl": "https://github.com/sinnwerkstatt/landmatrix",
     "projectDescription": "Independent global land monitoring initiative that promotes transparency & accountability in decisions over large-scale land acquisitions."},
    {"projectName": "Pymagicc", "projectUrl": "https://github.com/openscm/pymagicc",
     "projectDescription": "A Python wrapper around the reduced complexity climate model."},
    {"projectName": "Climsight", "projectUrl": "https://github.com/clidyn/climsight",
     "projectDescription": "A next-generation climate information system that uses large language models alongside high-resolution climate model data, scientific literature, and diverse databases to deliver accurate, localized, and context-aware climate assessments."},
    {"projectName": "Ecobricks", "projectUrl": "https://github.com/gea-ecobricks/ecobricks-org",
     "projectDescription": "Ecobrick is a plastic bottle packed with used plastic to a set density, a way to take advantage of plastic's pros while protecting against its cons."},
    {"projectName": "Gym Electric Motor", "projectUrl": "https://github.com/upb-lea/gym-electric-motor",
     "projectDescription": "An OpenAI Gym Environment for Electric Motors."},
    {"projectName": "Methane-detection-from-hyperspectral-imagery", "projectUrl": "https://github.com/satish1901/Methane-detection-from-hyperspectral-imagery",
     "projectDescription": "Deep Learning based Remote Sensing Methods for Methane Detection in Airborne Hyperspectral Imagery."},
    {"projectName": "etl", "projectUrl": "https://github.com/owid/etl",
     "projectDescription": "A compute graph for loading and transforming Our World in Data's data."},
    {"projectName": "WWTP", "projectUrl": "https://gitlab.com/hotmaps/potential/WWTP",
     "projectDescription": "EU28 Waste Water Treatment Plants."},
    {"projectName": "WoBike", "projectUrl": "https://github.com/ubahnverleih/WoBike",
     "projectDescription": "Public transport and multimodal routing apps could benefit from showing nearby bikes from bikesharing services. So here's a list showing the APIs of a few of these platforms."},
    {"projectName": "La Suite Drive", "projectUrl": "https://github.com/suitenumerique/drive/",
     "projectDescription": "Drive empowers teams to securely store, share, and collaborate on files while maintaining full control over their data through a user-friendly, open-source platform."},
    {"projectName": "Project AEDES", "projectUrl": "https://github.com/Cirrolytix/aedes_dpg",
     "projectDescription": "Project AEDES, by CirroLytix is a tool that correlates dengue cases and deaths with real-time data from climate, google searches, and remote sensing, to predict potential dengue hotspot locations."},
    {"projectName": "Data Observation Toolkit", "projectUrl": "https://github.com/datakind/Data-Observation-Toolkit",
     "projectDescription": "DOT is a toolkit that can be used to monitor data as it's collected and enters a database to flag problems with data integrity, data quality, protocols, outliers and other scenarios that might need attention."},
    {"projectName": "Grievance Redress System (GRS)", "projectUrl": "https://github.com/GRS-DPG",
     "projectDescription": "Grievance Redress System (GRS) is recognized worldwide as one of the enabling factors for organizations to be efficient, effective, and people-oriented."},
    {"projectName": "OpenFn", "projectUrl": "https://github.com/OpenFn/lightning",
     "projectDescription": "OpenFn is a workflow automation platform that's used to automate & integrate critical business processes and systems."},
    {"projectName": "Uwazi", "projectUrl": "https://github.com/huridocs/uwazi",
     "projectDescription": "Uwazi is an open-source web-based database application designed for human rights defenders to manage collections of information, including documents, evidence, cases and complaints."},
    {"projectName": "ODK", "projectUrl": "https://github.com/getodk",
     "projectDescription": "ODK lets you build powerful forms to collect the data you need wherever it is. Join the leading researchers, field teams, and other professionals using ODK to collect data that matters."},
    {"projectName": "Register for Organic Agriculture", "projectUrl": "https://github.com/shoqata-organika/register-for-organic-agriculture",
     "projectDescription": "ROA is an innovative software tool designed to simplify the record-keeping process for farmers and agribusinesses, ensuring compliance with organic standards and EU Regulation 2018/848 for organic agriculture."},
    {"projectName": "Uli", "projectUrl": "https://github.com/tattle-made/Uli",
     "projectDescription": "Uli is a browser plugin that provides tools for relief collective response to online gendered abuse. It is backed by open datasets of slurs and an ML model for redaction of gendered abuse in Indian languages."},
    {"projectName": "Cboard", "projectUrl": "https://github.com/cboard-org/cboard",
     "projectDescription": "Cboard is an Augmentative and Alternative Communication (AAC) web app for children and adults with speech and language impairments, aiding communication with symbols and text-to-speech."},
    {"projectName": "Creative Commons Legal Tools", "projectUrl": "https://github.com/creativecommons/cc-legal-tools-app/",
     "projectDescription": "CC legal tools enable the sharing and use of DPGs via standard, international open copyright licenses."},
    {"projectName": "finalsize", "projectUrl": "https://github.com/epiverse-trace/finalsize",
     "projectDescription": "finalsize is an R package that provides estimates for the total proportion of a population infected over the course of an epidemic."},
    {"projectName": "CodiTeach", "projectUrl": "https://github.com/codiplaykz/coditeach",
     "projectDescription": "CodiTeach is an innovative web platform for teachers that streamlines account management for schools, classes, and students."},
    {"projectName": "POTLOCK", "projectUrl": "https://github.com/potlock",
     "projectDescription": "POTLUCK is the portal for public goods, non-profits, and communities to raise funds transparently through a global donor network built on blockchain."},
    {"projectName": "QuarkID", "projectUrl": "https://github.com/ssi-quarkid",
     "projectDescription": "QuarkID is the digital trust framework developed by the Government of the City of Buenos Aires that creates a new digital identity system and gives people control over their information."},
    {"projectName": "WSO2 Identity Server", "projectUrl": "https://github.com/wso2/product-is",
     "projectDescription": "WSO2 Identity Server is an open-source Identity and Access Management (IAM) solution supporting secure authentication, identity federation, and user management."},
    {"projectName": "cQube", "projectUrl": "https://github.com/Sunbird-cQube/cQube_Base",
     "projectDescription": "cQube is an open-source platform for data-based insights. It allows for aggregated data to be visualized in a simple fashion, leading to insights and action."},
    {"projectName": "UrbanPy", "projectUrl": "https://github.com/EL-BID/urbanpy",
     "projectDescription": "A library to download, process and visualize high resolution urban data in an easy and fast way. It also estimates and visualizes urban service accessibility."},
    {"projectName": "Care | Open Healthcare Network", "projectUrl": "https://github.com/coronasafe/care",
     "projectDescription": "CARE is a transformative healthcare management system, centralizing patient and capacity management across hospitals."},
    {"projectName": "Statbus", "projectUrl": "https://github.com/statisticsnorway/statbus",
     "projectDescription": "Statbus is a web application for statistical offices, assisting and enabling them to build and maintain a business register that is the backbone for national accounts and economic statistics."},
